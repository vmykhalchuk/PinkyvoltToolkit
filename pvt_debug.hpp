...
namespace pvt::toolkit::debug {
  ...
  template<int LINE_PIN, uint8_t DATA_SIZE>
  class TXV2Dummy {
    private:
      static volatile uint8_t dataBuf[DATA_SIZE+2];
  ...
  bool RXV2Dummy<L,P>::_isReceivedData = false;
  template <uint8_t L, uint8_t P>
  uint8_t RXV2Dummy<L,P>::_receivedDataLength = 0;
  template <uint8_t L, uint8_t P>
  bool RXV2Dummy<L,P>::_isPrevTransmissionFailed = false;
  template <uint8_t L, uint8_t P>
  bool RXV2Dummy<L,P>::_isPrevPrevTransmissionFailed = false;

  template <uint8_t L, uint8_t P>
  uint8_t RXV2Dummy<L,P>::_receivedData[34] = {};
